// The board's MCP tools: names, descriptions, input schemas, and the dispatcher onto IAgentBoard.
// Generated once from the Python server it replaced; edited by hand from here on.
#nullable enable
